...
<div class="col-md-12 s-modal">
    <div class="s-modal__row row">
        <h3>Обсудить планировку с экспертом</h3>
        <div class="s-modal__descr">
            Оставьте заявку и получите подробную консультацию уже сегодня
        </div>
    </div>
    <div class="row">
    <form class="s-form__form" action="" method="POST" id="sofyno-bottom-form">
            <form class="s-form__form" action="" method="POST" id="sofyno-bottom-form">
                ...
                <div class="s-form__empty">
                    <input type="hidden" value="Планировка с экспертом" name="TYPE">
